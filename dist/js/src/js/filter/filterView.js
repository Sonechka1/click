                        ...
                        <div class="range__wrapper">
                            <label class="range">
                                ...
                                <input
                                    ...
                                    type="number"
                                    class="range__input"
                                     placeholder="${params.squareMin}" value="${params.squareMin}"
                                />
                            ...
                            <label class="range">
                                ...
                                <input
                                    ...
                                    type="number"
                                    class="range__input"
                                     placeholder="${params.squareMax}" value="${params.squareMax}"
                                />
                                <div class="range__value">м2</div>
                            </label>
                        </div>
                        ...
                        <div class="range__wrapper">
                            <div class="range">
                                ...
                                <input
                                    ...
                                    placeholder="${params.priceMin}" value="${params.priceMin}"
                                />
                            ...
                            <div class="range">
                                ...
                                <input
                                    ...
                                    min="0"
                                    class="range__input range__input--price"
                                    placeholder="${params.priceMax}" value="${params.priceMax}"
                                />
                                <div class="range__value">₽</div>
                            </div>
                        </div>
...
export function getInput(){
   ...
   //получаем параметры комнат checkbox
    const roomsValues = [];
    ...
    const roomsValueString = roomsValues.join(',');

    if(roomsValueString !== ''){
        searchParams.append('rooms', roomsValueString)
    }

 

   //получаем параметры площали и цены input
